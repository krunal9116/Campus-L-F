...
if (isset($_POST['report'])) {
    ...
    if (mysqli_query($conn, $insert)) {
        echo "<script>alert('Lost item reported successfully! Waiting for admin approval.'); window.location.href='user_dashboard.php';</script>";
    } else {
...
<head>
    ...
    <title>Report Lost Item - Campus Find</title>
        ...
        <div class="form-box">
            ...
            <form action="report_lost.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="location" placeholder="Where did you lose it?" required>
                </div>
                ...
                <div class="form-group">
                    <label>Upload Image <span class="optional-text">(Optional)</span></label>
                ...
                <button type="submit" name="report" class="btn-submit">Report Lost Item</button>
